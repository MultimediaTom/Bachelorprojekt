...
class Standard_action_index_178fc0100ef027f840f6eb9c38f04aa2b70fce5b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('url', $array7)]);
...
$output19 .= $renderingContext->getVariableProvider()->getByPath('name', $array20);
...
$array5 = array (
);$arguments3['each'] = $renderingContext->getVariableProvider()->getByPath('availableFunctions', $array5);
$arguments3['as'] = 'url';
$arguments3['key'] = 'name';
