...
class Standard_action_index_287c5792c293fc674c896d02efab86646bb75f58 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= $renderingContext->getVariableProvider()->getByPath('extension.version', $array37);
...
$output41 .= $renderingContext->getVariableProvider()->getByPath('extensionKey', $array42);

$output41 .= '\' => \'';
$array43 = array (
);
$output41 .= $renderingContext->getVariableProvider()->getByPath('version', $array43);
...
$array40 = array (
);$arguments38['each'] = $renderingContext->getVariableProvider()->getByPath('extension.dependencies', $array40);
$arguments38['as'] = 'version';
$arguments38['key'] = 'extensionKey';
